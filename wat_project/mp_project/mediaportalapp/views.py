...
from django.views.generic.list import ListView# va arata lista la toate articolele de pe site
...
from mediaportalapp.forms import CommentForm, RegistrationForms, LoginForms
...
class CreateCommentView(View):
	...
	def post(self,request,*args, **kwargs):
		article_id = self.request.POST.get('artcle_id')
